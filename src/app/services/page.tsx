...
export const metadata: Metadata = {
  title: "In-Home Technology Services & Support | Little Stone Tech Co.",
  description: "Friendly, patient, and professional technology help right at your kitchen table in St. Marys, ON. Security checkups, device setups, slow computer cleanups, and training. Ryan Wilson: 226-921-5949.",
};
